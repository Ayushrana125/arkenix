...
export function ClientsDataTable({ clientId }: ClientsDataTableProps) {
  ...
  const hasNewUserData = () => {
    return columns.some(col => newUserData[col] && newUserData[col].trim() !== '');
  };
        ...
        <div className="flex flex-wrap items-center gap-3 justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-md text-xs font-medium flex items-center gap-2 shadow-sm"
              style={{ fontFamily: 'Inter, sans-serif' }}
            >
